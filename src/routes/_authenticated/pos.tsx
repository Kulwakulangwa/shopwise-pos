      ...
      <div className="grid gap-4 lg:grid-cols-[1.4fr_1fr]">
        <div className="tile p-4">
          ...
          <div className="mt-5 space-y-2">
            {lines.map((l) => {
              // Compute serials for this product in the selected warehouse
              const availableSerials = ((serials.data ?? []) as any[])
                .filter((s: any) => s.product_id === l.productId && (!warehouseId || s.warehouse_id === warehouseId));
                    ...
                    <div className="mt-2 flex flex-wrap items-center gap-1.5">
                      ...
                      {availableSerials.length === 0 && (
                        <div className="w-full text-xs text-muted-foreground">
                          ...
                          <a
                            href="/inventory?tab=serials"
                            className="ml-1 text-primary underline"
                            onClick={(e) => {
                              e.preventDefault();
                              window.location.href = '/inventory?tab=serials';
                            }}
                          >
                            Register serials
                          </a>
